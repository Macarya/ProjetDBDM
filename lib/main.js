  ...
  bind_keyboard = function() {
    ...
    $('body').bind('keydown', function(e) {
		if (document.activeElement==myTextarea) {
			var TS = window.performance.timing.navigationStart + window.performance.now(); //Date.now()	
			$('#myTextarea2').val($('#myTextarea2').val() + ""+e.keyCode+ ",+,"+ TS+",");
		}
        return keyboard_msg_node.text("" + e.keyCode + " keyDown");
    }).bind('keyup', function(e) {
		//document.getElementById('myTextarea2').value += "" + e.keyCode " -";
		if (document.activeElement==myTextarea) {
			var TS = window.performance.timing.navigationStart + window.performance.now(); //Date.now()
			$('#myTextarea2').val($('#myTextarea2').val() + ""+e.keyCode+ ",-,"+TS+",");
		}
